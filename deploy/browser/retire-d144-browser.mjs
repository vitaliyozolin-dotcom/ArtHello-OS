...
// Retire only the recoverable browser image used by the accepted D144 release (only if no container uses it).
...
const BROWSER = {
  key: 'browser', id: 'sha256:a2f6aa28d907b2a9ce1d5de7c871e0af32ece7fda696cd70957c15f8da51a7c4',
  tags: ['arthello-e2e:' + SOURCE], repositories: ['arthello-e2e'], user: '1000:1000',
  fingerprint: '268c28e75c1b954dfe18066e209c8a52c5bd19be57e7c084134dcb4496cf4a0c',
  artifact: { id: 10196489198, name: `server-browser-${SOURCE}-34593160135-1`, size: 640788295,
    digest: 'sha256:996b59d29be50592f16879b31826513651ce28f1948b47483000f228db7b7e34', run: 34593160135 },
};
...
export async function retireD144Browser(dependencies = {}) {
  ...
  const receipt = { kind: 'd144-browser-retirement', result: 'blocked', browser: 'not_checked' };
  let stage = 'inputs';
  try {
...
if (process.argv[1] && import.meta.url === pathToFileURL(process.argv[1]).href) {
  const result = process.argv.length === 2 ? await retireD144Browser()
    : { kind: 'd144-browser-retirement', result: 'blocked', reason: 'retirement_arguments_failed' };
