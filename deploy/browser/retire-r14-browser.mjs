...
// Retire only the recoverable browser image used by the failed R14 release (no candidate cutover).
...
const BROWSER = {
  key: 'browser', id: 'sha256:19a8671fd03ba31bcfc3ddc7d479dceeabcfbcb836b61bfa7fda17fbf8f77f1a',
  ...
  artifact: { id: 10119716232, name: `server-browser-${SOURCE}-34391105865-1`, size: 640801625,
    digest: 'sha256:0835c0a93f375c847d52d9e5178b4f5570e450cba1a61407b976536a46872102', run: 34391105865 },
};
...
export async function retireR14Browser(dependencies = {}) {
  ...
  const receipt = { kind: 'r14-browser-retirement', result: 'blocked', browser: 'not_checked' };
  let stage = 'inputs';
  try {
...
if (process.argv[1] && import.meta.url === pathToFileURL(process.argv[1]).href) {
  const result = process.argv.length === 2 ? await retireR14Browser()
    : { kind: 'r14-browser-retirement', result: 'blocked', reason: 'retirement_arguments_failed' };
