...
// Retire only the recoverable browser image used by the accepted R15 release (only if no container uses it).
...
const BROWSER = {
  key: 'browser', id: 'sha256:6ab75a9ba76c0df8439fd2f4a532191bd4f86fc641eaf7c50a4e2be1385b5977',
  ...
  artifact: { id: 10139358225, name: `server-browser-${SOURCE}-34445017241-1`, size: 640796077,
    digest: 'sha256:c80713c5d61a29c0c6d8b9e9860f14029f6ff96ba264b11f445bde9854eadc7a', run: 34445017241 },
};
...
export async function retireR15Browser(dependencies = {}) {
  ...
  const receipt = { kind: 'r15-browser-retirement', result: 'blocked', browser: 'not_checked' };
  let stage = 'inputs';
  try {
...
if (process.argv[1] && import.meta.url === pathToFileURL(process.argv[1]).href) {
  const result = process.argv.length === 2 ? await retireR15Browser()
    : { kind: 'r15-browser-retirement', result: 'blocked', reason: 'retirement_arguments_failed' };
