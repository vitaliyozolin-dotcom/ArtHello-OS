...
// Retire only the recoverable browser image used by the accepted D145 release (only if no container uses it).
...
const BROWSER = {
  key: 'browser', id: 'sha256:9c57b128a54eec71a88516512a21ac28dea3f53782c5f4e385dd3a6096d58dfd',
  tags: ['arthello-e2e:' + SOURCE], repositories: ['arthello-e2e'], user: '1000:1000',
  fingerprint: '01e7affd1693882763b8546af85c15038e0eef3f02ec6b261259949aec047244',
  artifact: { id: 10261836819, name: `server-browser-${SOURCE}-34595178841-1`, size: 640801336,
    digest: 'sha256:d3a6623577671aa9efd7e9c43a7fb9f2bd59823bc690d5db6fbabb499cb2ef04', run: 34595178841 },
};
...
export async function retireD145Browser(dependencies = {}) {
  ...
  const receipt = { kind: 'd145-browser-retirement', result: 'blocked', browser: 'not_checked' };
  let stage = 'inputs';
  try {
...
if (process.argv[1] && import.meta.url === pathToFileURL(process.argv[1]).href) {
  const result = process.argv.length === 2 ? await retireD145Browser()
    : { kind: 'd145-browser-retirement', result: 'blocked', reason: 'retirement_arguments_failed' };
