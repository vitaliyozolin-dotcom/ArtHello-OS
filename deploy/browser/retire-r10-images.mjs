...
// R12 retires only the recoverable, previously imported R10 browser image. The frozen
// D079/D084 helpers, capacity model and the live application's data are untouched.
const SOURCE = '2e57dd22c6ff1cec1fcad0bd11af479e465c00bb';
const MAIN_PATH = '/git/ref/heads/main';
const BROWSER = {
  key: 'browser', id: 'sha256:44ef654e88c3e92d4e1a1d967b5054594b0b7ed96928819111ba52fee28d937d',
  tags: ['arthello-e2e:' + SOURCE], repositories: ['arthello-e2e'], user: '1000:1000',
  fingerprint: '9efafc066c918c5d68188e4eb3bc23c2feba82eb02875442d3db1072bafc1696',
  artifact: { id: 10092321489, name: `server-browser-${SOURCE}-34322039891-1`, size: 640802387,
    digest: 'sha256:6d4b187bf776d59a4386e19b03993c29f939a31b610444c058ce59b4fca1f53e', run: 34322039891 },
};
...
export async function retireR10Images(dependencies = {}) {
  ...
  const receipt = { kind: 'r10-image-retirement', result: 'blocked', browser: 'not_checked' };
  let stage = 'inputs';
  try {
...
if (process.argv[1] && import.meta.url === pathToFileURL(process.argv[1]).href) {
  const result = process.argv.length === 2 ? await retireR10Images()
    : { kind: 'r10-image-retirement', result: 'blocked', reason: 'retirement_arguments_failed' };
