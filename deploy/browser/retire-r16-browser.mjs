...
// Retire only the recoverable browser image used by the accepted R16 release (only if no container uses it).
...
const BROWSER = {
  key: 'browser', id: 'sha256:104c3c4b35d236f020111e6dfc0bf2bfd0d99ca9a083cf373424747f2f6846b9',
  tags: ['arthello-e2e:' + SOURCE], repositories: ['arthello-e2e'], user: '1000:1000',
  fingerprint: '738757d0a2ef0805c5f139fb48e9afc079cfdae874eaf6364eab838a983daa04',
  artifact: { id: 10145756776, name: `server-browser-${SOURCE}-34461449594-1`, size: 640802987,
    digest: 'sha256:aa4ea805899ff06244cfad407aa1ea0393edf0c4b6e73030fcfc656c17477073', run: 34461449594 },
};
...
export async function retireR16Browser(dependencies = {}) {
  ...
  const receipt = { kind: 'r16-browser-retirement', result: 'blocked', browser: 'not_checked' };
  let stage = 'inputs';
  try {
...
if (process.argv[1] && import.meta.url === pathToFileURL(process.argv[1]).href) {
  const result = process.argv.length === 2 ? await retireR16Browser()
    : { kind: 'r16-browser-retirement', result: 'blocked', reason: 'retirement_arguments_failed' };
