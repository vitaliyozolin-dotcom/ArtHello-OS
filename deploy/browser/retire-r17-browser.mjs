...
// Retire only the recoverable browser image used by the accepted R17 release (only if no container uses it).
...
const BROWSER = {
  key: 'browser', id: 'sha256:c158743b8877db1648f5048fdda69cce962d325285630a100c1e451829ab9e99',
  tags: ['arthello-e2e:' + SOURCE], repositories: ['arthello-e2e'], user: '1000:1000',
  fingerprint: 'e05306e01e58c2b51330a7a1403ac0c798ee89e687a1c834c557d13964d03822',
  artifact: { id: 10159561231, name: `server-browser-${SOURCE}-34495273615-1`, size: 640794811,
    digest: 'sha256:e5770042a713f2a24ef9cd2f8b0f7b167e83b9811fc79e1e83ecde30481546c8', run: 34495273615 },
};
...
export async function retireR17Browser(dependencies = {}) {
  ...
  const receipt = { kind: 'r17-browser-retirement', result: 'blocked', browser: 'not_checked' };
  let stage = 'inputs';
  try {
...
if (process.argv[1] && import.meta.url === pathToFileURL(process.argv[1]).href) {
  const result = process.argv.length === 2 ? await retireR17Browser()
    : { kind: 'r17-browser-retirement', result: 'blocked', reason: 'retirement_arguments_failed' };
