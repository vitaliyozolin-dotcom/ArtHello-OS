...
// Retire only the recoverable browser image used by the accepted R12 release.
...
const BROWSER = {
  key: 'browser', id: 'sha256:e07d75e5964218b4382d98e255c5f17829dc6a4429ccef3060fb833d4cc3b61f',
  ...
  artifact: { id: 10094111549, name: `server-browser-${SOURCE}-34326582961-1`, size: 640811234,
    digest: 'sha256:b4b05bbddb30dbd6a0745a6d5e54f9f1b6199a4e5166d12a511fd2b27aedf821', run: 34326582961 },
};
...
export async function retireR12Browser(dependencies = {}) {
  ...
  const receipt = { kind: 'r12-browser-retirement', result: 'blocked', browser: 'not_checked' };
  let stage = 'inputs';
  try {
...
if (process.argv[1] && import.meta.url === pathToFileURL(process.argv[1]).href) {
  const result = process.argv.length === 2 ? await retireR12Browser()
    : { kind: 'r12-browser-retirement', result: 'blocked', reason: 'retirement_arguments_failed' };
