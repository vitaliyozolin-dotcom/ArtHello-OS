...
// Retire only the recoverable browser image used by the accepted D143 release (only if no container uses it).
...
const BROWSER = {
  key: 'browser', id: 'sha256:30bce9433c3dd455bfa89fef9b7bd733aa15eae94c28edd1d0859fe828e486d7',
  tags: ['arthello-e2e:' + SOURCE], repositories: ['arthello-e2e'], user: '1000:1000',
  fingerprint: '2eff806c5998095dfebeb0d80ecd5955171b8357aee287554a0af86947b24945',
  artifact: { id: 10195789841, name: `server-browser-${SOURCE}-34591320950-1`, size: 640808941,
    digest: 'sha256:fc3dcad818bdc864529e118d382732cdbbcfe3aeacdcd512dc22392ce481b013', run: 34591320950 },
};
...
export async function retireD143Browser(dependencies = {}) {
  ...
  const receipt = { kind: 'd143-browser-retirement', result: 'blocked', browser: 'not_checked' };
  let stage = 'inputs';
  try {
...
if (process.argv[1] && import.meta.url === pathToFileURL(process.argv[1]).href) {
  const result = process.argv.length === 2 ? await retireD143Browser()
    : { kind: 'd143-browser-retirement', result: 'blocked', reason: 'retirement_arguments_failed' };
