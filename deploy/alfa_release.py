...
PINS = {
    'central': ('8b58c8394aaf7d1c4b75ed7e518e308abd17d41d', None),
...
def main():
    ...
    if system == 'central':
        require(old['Id'] == 'a2c15d49379bb1da122f62760cad4c5f86eca32c8b2ed08244e6e2e6eca0518c', 'PREDECESSOR_INVENTORY')
    public_health()
