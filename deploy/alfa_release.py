...
PINS = {
    'central': ('547e3fec1cbd9bc3bb6a89a233c68552946dd093', None),
...
def main():
    ...
    if system == 'central':
        require(old['Id'] == 'bf5cc41fb61fdd4fe5ba1e4e390724fc1f8336119a3e82477e6f23566da3c855', 'PREDECESSOR_INVENTORY')
    public_health()
