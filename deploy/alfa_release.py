...
PINS = {
    'central': ('a539332b43a7758fba896ddc577592cb5c63f882', None),
...
def main():
    ...
    if system == 'central':
        require(old['Id'] == 'f96016dcb48bd5c136d13e1002d2052f3f60764145fdcf32755ffa0f7653f58e', 'PREDECESSOR_INVENTORY')
    public_health()
