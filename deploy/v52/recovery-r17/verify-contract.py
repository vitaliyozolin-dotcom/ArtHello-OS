...
CHANGED_FROZEN_INPUTS = {'deploy/school-source-manifest.json', 'deploy/v52/Dockerfile', 'deploy/v52/src/lib/tochka-autosync.ts', 'scripts/test/school-source.test.mjs', 'scripts/verify-school-source.mjs'}
EXTRA_INPUTS = {'.github/scripts/finance-ci-browser.mjs', '.github/scripts/finance-ci-seed.mjs', '.github/scripts/fixtures/r17-accepted-r16-history.json', '.github/scripts/r17-backup-adoption.py', '.github/scripts/r17-backup-controller.py', '.github/scripts/r17-candidate-state.py', '.github/scripts/r17-history-gate.py', '.github/scripts/r17-live-baseline.py', '.github/scripts/r17-public-audit.py', '.github/scripts/r17-resume-candidate.py', '.github/scripts/run-finance-ci-browser.sh', '.github/scripts/run-r17-live-browser.py', '.github/scripts/test-r17-backup-adoption.py', '.github/scripts/test-r17-backup-controller.py', '.github/scripts/test-r17-continuation-adapters.py', '.github/scripts/test-r17-contract.py', '.github/scripts/test-r17-history-gate.py', '.github/scripts/test-r17-live-baseline.py', '.github/scripts/test-run-finance-ci-browser.py', '.github/scripts/test-run-r17-live-browser.py', '.github/workflows/verify-arthello-v52.yml', 'deploy/browser/retire-r16-browser.mjs', 'deploy/school-source-manifest.json', 'deploy/v52/Dockerfile', 'deploy/v52/recovery-r16/check-contract.rb', 'deploy/v52/recovery-r16/r15-controller.yml', 'deploy/v52/recovery-r16/source-pins.json', 'deploy/v52/recovery-r16/transform.json', 'deploy/v52/recovery-r17/verify-contract.py', 'deploy/v52/src/app/api/finance-actions/route.ts', 'deploy/v52/src/app/api/finance/route.ts', 'deploy/v52/src/lib/finance-article-store.ts', 'deploy/v52/src/lib/finance-articles.ts', 'deploy/v52/src/lib/tochka-autosync.ts', 'deploy/v52/src/tests/finance-article-store.test.mjs', 'deploy/v52/src/tests/finance-articles-api.test.mjs', 'deploy/v52/src/tests/finance-articles-d1.test.mjs', 'deploy/v52/src/tests/finance-articles.test.mjs', 'scripts/run-accepted-r16-history.py', 'scripts/test/accepted-r16-history.test.py', 'scripts/test/retire-r16-browser.test.mjs', 'scripts/test/school-source.test.mjs', 'scripts/verify-school-source.mjs'}
