import { acquireTochkaStatementState, tochkaStatementLeaseGuardSql } from '../lib/tochka-statement-state.ts';
...
async function loadDbModule(database) {
  ...
  globalThis.__ARTHELLO_EMPTY_MODE_TOCHKA_STATE__ = { acquireTochkaStatementState, tochkaStatementLeaseGuardSql };
  try {
