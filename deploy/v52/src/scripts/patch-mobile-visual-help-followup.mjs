...
// Semantic, block-by-block guide for the owner dashboard.
{
  ...
  steps: [
    ...
    { id:"dashboard-operations", selector:'[data-help-block="operations"]', title:"Банковский итог", text:"На главной показан только краткий итог. Единственная полная история операций находится в разделе «Деньги».", can:"Выбрать месяц и открыть историю операций.", cannot:"Использовать главную как второй банковский реестр." },
  ],
};
