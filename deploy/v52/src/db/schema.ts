...
export const financialOperations = sqliteTable("financial_operations", {
  ...
  // D069_FINANCE_OPERATION_ALLOCATION: editable management allocation; immutable bank fact remains in bank_transactions.
