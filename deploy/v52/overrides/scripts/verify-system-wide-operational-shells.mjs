...
requireText(readiness, "<KpiCard", "readiness KPI cards are missing");
forbid(readiness, /\breadiness-workspace\b/, "legacy readiness workspace wrapper remains");
forbid(readiness, /if\s*\(\s*!data\.scenarios\.length\s*\)\s*\{\s*return/, "readiness workspace still collapses when empty");
