...
const OPERATING_CATALOG: CatalogConnection[] = [
  ...
  { id: "INT-T-TOCHKA", system: "Банк Точка", category: "Банк", targetModule: "Финансы", ownerEntityId: "ROLE:OWNER", sourceOfTruth: "Банк Точка", mode: "Защищённое подключение · проверка компании и доступных счетов", impact: "Критичное: загрузка банковских операций Точки ещё не реализована", adapterVersion: "bank-tochka@1" },
