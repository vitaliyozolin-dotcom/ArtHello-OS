...
import { patchD066Integrations, patchD066FinanceRoute, patchD066FinanceWorkspace, patchD066FinanceCss } from "../scripts/patch-tochka-finance-bank-visibility-v2.mjs";
...
test("D-066 finance API exposes safe bank balances without provider account ids", async () => {
...
test("D-066 finance UI renders bank accounts and current balances at zero operations", async () => {
