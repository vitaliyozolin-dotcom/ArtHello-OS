...
Первый protected D122 run `34520906921/103018492882` остановился до container/Caddy mutation после успешных artifact checksums: gateway Docker не разрешил raw image-ID lookup после load. D124 использует immutable source tag и обязательно сверяет его с тем же receipt image ID; остальные ворота неизменны.
