...
### D-082 — Фактический отказ маршрута до авторизации и диагностика
...
- Полный scope, границы, AI-контракт, метрика и остановка: DECISIONS D082. Владелец и исходная авторизация неизменны; новые пароли, роли или общий допуск не запрашиваются. Исходная бизнес-приёмка остаётся незавершённой.
