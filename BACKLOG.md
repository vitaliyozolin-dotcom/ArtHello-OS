...
- [ ] `UX-FEEDBACK-SECTION`: отдельный раздел «Обращения и улучшения» со всеми предложениями и ошибками для собственника. Пока отложено; существующее окно сохранить. Источник решения — дополнение в docs/PROJECT_PASSPORT_PRODUCTION_RU.md.
- [ ] `UX-SCHOOL-RETURN`: кнопка «Вернуться в ArtHello OS» в дневнике для сотрудников, заметная на телефоне и компьютере, без выхода из сессии. Исходное обращение уже существует внутри OS, повторное сообщение не создавать. Подготовить отдельный School-кандидат; завершить только после проверки опубликованной версии.


## Уточнение владельца — 2026-09-10

- [x] Разграничить учреждения в постановке задачи: «Атлас» и «Школа 1–11» — разные школы, подтверждено Виталием. Екатерина Груданова относится к школе и садику «Атлас».
- [ ] `ATLAS-ACADEMIC-LEAD`: кабинет руководителя учебной части «Атласа» — расписание и замены, события, программы, доступные классы/группы, опубликованная обратная связь и учебный предпросмотр родителя. Область: BR-ATLAS-SCHOOL и BR-KINDERGARTEN после проверки рабочих назначений. BR-SCHOOL / SYS-SCHOOL-1-11 не входят в это поручение. Подробные критерии и факты — дополнение от 2026-09-10 в docs/PROJECT_PASSPORT_PRODUCTION_RU.md.
- [ ] `ATLAS-DIARY-ENTRY`: подтвердить существующий адрес/проект дневника «Атласа» либо определить необходимость нового. В проверенных исходниках EducationWorkspace общая кнопка «Открыть дневник» ведёт в «Школу 1–11» при любом выбранном филиале. Указать учреждение в переходе и привязать его к правильному дневнику после подтверждения назначения.
- PR402 — черновик учебного предпросмотра для приложения «Школа 1–11», не выполнение задачи Кати. Публикации и назначения прав не было. PR401 с кнопкой возврата остаётся отдельной задачей.


### Продолжение решения 2026-09-10: шаблон нового дневника «Атласа»

- [x] Для ATLAS-DIARY-ENTRY закрыт вопрос о наличии дневника: Виталий подтвердил, что у «Атласа» своего дневника нет. Искать его адрес больше не требуется.
- [ ] ATLAS-ACADEMIC-LEAD: создать новый дневник по шаблону «Школы 1–11», с собственными данными и правами «Атласа», адаптацией школы и садика, кабинетом Кати и родительским предпросмотром. Прежняя постановка расширена этим решением; отдельная дублирующая задача не создаётся.
- [ ] ATLAS-DIARY-ENTRY: при реализации нового дневника назначить собственную системную привязку и адрес, настроить правильный переход из ArtHello и возврат. SYS-SCHOOL-1-11 не использовать как идентичность «Атласа».
- Текущий результат: решение сохранено; реализация и публикация нового дневника не выполнены. Критерии и маршрут — «Новый дневник “Атласа” по шаблону “1–11”» в существующем паспорте. Приоритет интеграций Точка → АльфаCRM сохранён.


## Проверка образовательных сценариев — 2026-09-10

Проверено 44/44 теста версии «1–11» 54242340, но полный цикл сотрудников не принят. Отчёт: docs/acceptance/2026-09-10-education-workflows-audit.md.

- [ ] EDU-ATTENDANCE-DATE: ввод посещаемости и сохранение по дате конкретного занятия; воспроизведена замена предыдущей недельной отметки.
- [ ] EDU-CALENDAR-EDITOR: настройка учебного года и неучебных периодов через интерфейс.
- [ ] EDU-DATED-REPLACEMENT: разовая замена/отмена по дате, отдельно от изменения недельной сетки.
- [ ] EDU-SCHEDULE-XLSX-UI: пользовательский импорт расписания, отдельно от работающего импорта КТП.
- [ ] EDU-EVENT-AUDIENCE: серверная фильтрация событий по назначенной аудитории.
- [ ] Проверить фактическую роль Наталии Витальевны и назначения педагогов через рабочую систему; текущий облачный браузер получил 502. Роль Кати и доступ в будущий дневник «Атласа» — в существующей ATLAS-ACADEMIC-LEAD.
- Доработки выявлены аудитом; код и production не изменены. Автосдвиг всех тем не включать без пересмотра прежнего решения владельца.
