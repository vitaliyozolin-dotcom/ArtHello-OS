...
- [ ] D186: повторить отдельный Atlas release с WAL-полной standalone backup из read-only data snapshot; D183–D185 безопасно откатились до central/route cutover.
