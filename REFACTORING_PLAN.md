...
1. **[частично] [DEL]** Три cleanup-блока архивировали и удалили 33 завершённых workflow: D060–D069, recovery R2–R12, ранние School diagnostics/cutover, legacy RU D059, R12 verifier и D092 artifact inspector; активный набор сокращён с 47 до 14, а `workflow_run` consumers — с 17 до 5. Checked-in ratchet запрещает незаявленный рост выше 14. Blob provenance сохранён в `docs/workflow-archive-2026-09-09.md`; R13 и текущие checks оставлены до сверки фактических Actions runs и run URL.
