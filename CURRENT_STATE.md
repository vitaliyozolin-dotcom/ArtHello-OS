...
- D127 protected run `34526464994/103037110088` прошёл portable image provenance и остановился до контейнеров/Caddy: снимки Caddy после `docker cp` не имели обязательный для защитного parser режим `0600`. D128 выставляет этот file mode до parse; production Atlas ещё не принят.
