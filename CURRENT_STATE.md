...
## D180 — Завершение пакетного импорта и видимость клиентов (2026-09-14, кандидат)
...
Кандидат перебазирован на подтверждённый D179 release `a2f30685f037e540206f459c34a6c37e90d3b95b`; D180 controller принимает только его exact production receipt и live image/container. Пройдены 107/107 целевых AlfaCRM/реестровых контрактов, typecheck, production build и lint без ошибок; в полном локальном наборе 833 теста прошли, 6 старых owner/chown-тестов несовместимы с managed filesystem (`EINVAL`), 2 штатно пропущены. Отработавшие D173/D178/D179 one-shot workflow сохранены неизменяемыми contract fixtures, постоянные Quality и Proof Gates остаются активными. Production ещё не объявлен обновлённым: требуются exact-main Quality/Proof/Verify, rollback snapshot, exact hosted image, live AlfaCRM state, 65 секунд стабильности и независимый внешний probe.
