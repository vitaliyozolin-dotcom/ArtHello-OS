...
## D179 — Единая банковская история и компактная карточка операции (2026-09-14, кандидат)
...
Кандидат прошёл TypeScript, production build, lint без ошибок и 93/93 связанных D179/канонических/UI-контрактов. Новый release controller до переключения требует сохранения активированного импорта AlfaCRM, банковских счетов и остатков, Pay grants и read-only синхронизации. Exact GitHub-hosted Quality/Verify и изолированный Chromium-сценарий обязательны до объявления production-выпуска.
