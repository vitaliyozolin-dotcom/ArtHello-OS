...
- D126 protected run `34524982542/103032229379` доказал cross-daemon ID rewrite: builder receipt image `sha256:3bc9ae0d...`, gateway-loaded image `sha256:70466bbc...`; он остановился до контейнеров/Caddy. D127 переносит обязательную границу на точный SHA-256 архива плюс source/tree labels и записывает оба daemon-local ID в receipt; production Atlas ещё не принят.
...
## 2026-09-10 — D128: филиальный финансовый контур с 01.09.2026
