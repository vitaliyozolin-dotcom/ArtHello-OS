...
## D172 — Единый банковский источник и постоянные границы разделов (2026-09-13, кандидат)
...
Кандидат содержит общий серверный расчёт банковского периода, явные подписи двух уровней учёта и регрессионный контракт против возврата банковских таблиц в «Эквайринг». Production-выпуск и мобильная проверка ещё не выполнены.
