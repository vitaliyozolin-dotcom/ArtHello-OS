...
export const LEGACY_POOL_QUERY_BASELINE = Object.freeze({
  ...
  "artifacts/api-server/src/features/coverage-audits/attendance-student-identity.ts": 2,
  "artifacts/api-server/src/features/coverage-audits/customer-branch-coverage.ts": 4,
  "artifacts/api-server/src/features/educational-module/router.ts": 15,
  "artifacts/api-server/src/features/employees-module/router.ts": 16,
  "artifacts/api-server/src/routes/coverage/duplicates.ts": 7,
  "artifacts/api-server/src/routes/coverage/shared.ts": 1,
