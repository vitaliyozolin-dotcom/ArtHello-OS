...
COMMANDS = {
    "r12": "ruby deploy/v52/recovery-r12/check-contract.rb\npython3 -I .github/scripts/test-r12-replay-guard.py\nnode --test scripts/test/retire-r10-images.test.mjs\nnode --check deploy/browser/retire-r10-images.mjs\n",
