...
root = 'deploy/school/sso-relay-r3'
manifest = JSON.parse(File.read("#{root}/manifest.json"))
raise 'R3 configuration-only scope changed' unless manifest['schemaVersion'] == 2 && manifest['decisionId'] == 'D065' && manifest['school'] == {'container'=>'school-1-11','sourceSha'=>'54242340f2d9b6a9887d69ecc03520ddf9f7982c','imageId'=>'sha256:664c2c0c3e628a53ca492953803b420e0c4a44acab35eb250f5f899c10bc93df','network'=>'arthello-os_backend'}
