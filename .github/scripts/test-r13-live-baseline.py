...
spec = importlib.util.spec_from_file_location("baseline", Path(__file__).with_name("r13-live-baseline.py"))
...
class BaselineTests(unittest.TestCase):
    ...
    def test_cli_failure_does_not_expose_docker_or_file_content(self):
        ...
        self.assertEqual(json.loads(output.getvalue()), {"kind": "r13-live-identity", "result": "blocked", "reason": "identity_mismatch"})
