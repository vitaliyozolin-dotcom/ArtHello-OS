...
report="$RUNNER_TEMP/r8-browser-$GITHUB_RUN_ID-$GITHUB_RUN_ATTEMPT-$BROWSER_PHASE.json"
...
BROWSER_REPORT_FILE="$report" python3 -I .github/scripts/r8-live-browser-acceptance.py
