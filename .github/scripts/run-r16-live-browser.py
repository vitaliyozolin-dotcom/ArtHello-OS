...
PINS = {
    "r16-candidate-state.py": "de2a02f4b567935cc6ec1e627b6b53a3d948eb5ac7f03aeb92927b85d9c06600",
...
def checked_state():
    ...
    module.__file__ = str(HERE / "r16-candidate-state.py")
    exec(compile(sources["r16-candidate-state.py"], module.__file__, "exec"), module.__dict__)
    return module
