#!/usr/bin/env python3
"""Read-only accepted R15 identity checks for a fresh R16 continuation.
...
separately verified durable context instead of pretending R15 is still running.
"""
import json
import os
import stat
...
ACCEPTED_SHA = 'cb990279e070fddbfa9a0adbd21b56de25b85588'
...
ACCEPTED_APP_ID = 'd012fe547d8e57d13677d921b07d7847219705a4e0202faee3134c328f07c498'
ACCEPTED_RUN = '34461449594'
ACCEPTED_NAME = '/arthello-direct-34461449594-1'
