"""R15 history gate with unchanged R14 durable protocol: accepted R13 success plus preserved candidate replay rules."""
import ast
import hashlib
import json
import os
...
CONSUMER_PATH = '.github/workflows/deploy-arthello-tochka-r15-20260910.yml'
...
FORBIDDEN_RUNS = {34443217193, 34391105865, ACCEPTED_RUN, 34326582961, 34208952716, 34221458013, 34227595623,
...
PRESTEPS = [
    ...
    'Retire only the exact unused R14 browser image',
