...
resume = load('r14_resume_test', 'r17-resume-candidate.py')
state = resume.state
adoption = state.adoption
public = load('r14_public_test', 'r17-public-audit.py')
...
backup_tests = load('r14_backup_fixture', 'test-r17-backup-adoption.py')
controller_tests = load('r14_controller_fixture', 'test-r17-backup-controller.py')
private, json_bytes = old_tests.private, old_tests.json_bytes
REFUSED = (ValueError, adoption.r7.Refused, public.state.adoption.r7.Refused, resume.controller.r7.Refused, resume.controller.historical.r7.Refused, resume.controller.historical.historical.r7.Refused, OSError, AssertionError)
...
class AdapterTests(unittest.TestCase):
    ...
    def test_resume_uses_receipt_bound_historical_predecessor_without_deleting_it(self):
        ...
        with patch.object(resume.controller, 'ACCEPTED_CONTEXT_SHA256', historical.historical['contextSha256']), \
                ...
                patch.object(resume.controller.historical, 'LIVE_CONTEXT_SHA256', historical.r15_historical['contextSha256']), \
                patch.object(resume.controller.historical.historical, 'LIVE_CONTEXT_SHA256', historical.r13_historical['contextSha256']), \
                patch.object(resume.controller.historical.historical, 'ACCEPTED_CONTEXT_SHA256', historical.historical['contextSha256']), \
