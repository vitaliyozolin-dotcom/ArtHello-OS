...
PINS = {
    "r14-candidate-state.py": "4e7aa40e62cd372ad1a4cb84cd2dc6c0c0bcdb812dbb282d7ff52b6dcb49779b",
...
def checked_state():
    ...
    module.__file__ = str(HERE / "r14-candidate-state.py")
    exec(compile(sources["r14-candidate-state.py"], module.__file__, "exec"), module.__dict__)
    return module
