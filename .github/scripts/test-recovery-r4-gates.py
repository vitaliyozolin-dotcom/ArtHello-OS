...
acceptance = load('acceptance', 'check-school-live-acceptance-r4.py')
replay = load('replay', 'd066-replay-guard.py')
...
def step_script(step_id):
    path = Path(__file__).resolve().parents[1] / 'workflows/deploy-arthello-recovery-r4-20260908.yml'
