...
CONSUMER_PATH = '.github/workflows/deploy-arthello-recovery-r7-20260908.yml'
...
def run():
    ...
    assert release != INSTALL_SHA, 'R7 candidate identity must differ from preserved installation'
    ...
    print('ARTHELLO_D069_PRESERVED_R5_AND_REPLAY_BOUNDARY=VERIFIED')
