...
WORKFLOW = Path(__file__).parents[1] / 'workflows/deploy-arthello-recovery-r10-20260909.yml'
...
fragment = activation[activation.index('python3 -I .github/scripts/d083-candidate-state.py begin'):]
