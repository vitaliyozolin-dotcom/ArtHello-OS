...
path = Path(__file__).with_name('r13-history-gate.py')
spec = importlib.util.spec_from_file_location('history', path)
gate = importlib.util.module_from_spec(spec)
spec.loader.exec_module(gate)
# Sanitized actual GitHub metadata for accepted R12, not generated from gate expectations.
ACTUAL = json.loads(r'''{"run":{"id":34326582961,"name":"Deploy ArtHello recovery R12 D086","path":".github/workflows/deploy-arthello-recovery-r12-20260909.yml","head_sha":"77f26ec9bcba7233f39d5e8cb9f59c276bc8c1ed","head_branch":"main","event":"workflow_run","run_attempt":1,"status":"completed","conclusion":"success","repository":{"full_name":"vitaliyozolin-dotcom/ArtHello-OS"},"head_repository":{"full_name":"vitaliyozolin-dotcom/ArtHello-OS"},"actor":{"login":"vitaliyozolin-dotcom"},"triggering_actor":{"login":"vitaliyozolin-dotcom"}},"jobs":{"total_count":2,"jobs":[{"id":102385622798,"name":"bundle","run_id":34326582961,"run_attempt":1,"head_sha":"77f26ec9bcba7233f39d5e8cb9f59c276bc8c1ed","head_branch":"main","status":"completed","conclusion":"success","labels":["ubuntu-latest"],"steps":[{"name":"Set up job","number":1,"status":"completed","conclusion":"success"},{"name":"Run actions/checkout@11d5960a326750d5838078e36cf38b85af677262","number":2,"status":"completed","conclusion":"success"},{"name":"Run actions/setup-node@49933ea5288caeca8642d1e84afbd3f7d6820020","number":3,"status":"completed","conclusion":"success"},{"name":"Test browser policy and install locked package off the VPS","number":4,"status":"completed","conclusion":"success"},{"name":"Build immutable bundle and exercise Chromium sandbox and natural flow fixture","number":5,"status":"completed","conclusion":"success"},{"name":"Run actions/upload-artifact@ea165f8d65b6e75b540449e92b4886f43607fa02","number":6,"status":"completed","conclusion":"success"},{"name":"Post Run actions/setup-node@49933ea5288caeca8642d1e84afbd3f7d6820020","number":11,"status":"completed","conclusion":"success"},{"name":"Post Run actions/checkout@11d5960a326750d5838078e36cf38b85af677262","number":12,"status":"completed","conclusion":"success"},{"name":"Complete job","number":13,"status":"completed","conclusion":"success"}]},{"id":102386111240,"name":"deploy","run_id":34326582961,"run_attempt":1,"head_sha":"77f26ec9bcba7233f39d5e8cb9f59c276bc8c1ed","head_branch":"main","status":"completed","conclusion":"success","labels":["self-hosted","linux","x64","arthello-gateway"],"steps":[{"name":"Set up job","number":1,"status":"completed","conclusion":"success"},{"name":"Verify D086 R12 identity and preserved R5 R8 R9 R10 R11 abort boundary","number":2,"status":"completed","conclusion":"success"},{"name":"Wait for exact main Quality Proof and v52 verification","number":3,"status":"completed","conclusion":"success"},{"name":"Check out exact verified release","number":4,"status":"completed","conclusion":"success"},{"name":"Verify checkout and release contracts","number":5,"status":"completed","conclusion":"success"},{"name":"Verify retained candidate before any replay skip","number":6,"status":"completed","conclusion":"skipped"},{"name":"Verify installed R5 School relay with fresh receipt","number":7,"status":"completed","conclusion":"success"},{"name":"Check existing gateway Docker authority","number":8,"status":"completed","conclusion":"success"},{"name":"Check current release and existing browser runtime","number":9,"status":"completed","conclusion":"success"},{"name":"Retire only the exact unused R9 browser image under D084","number":10,"status":"completed","conclusion":"success"},{"name":"Retire only unused recoverable R10 images for import capacity under D086","number":11,"status":"completed","conclusion":"success"},{"name":"Measure import capacity before downloading the verified archive","number":12,"status":"completed","conclusion":"success"},{"name":"Run actions/download-artifact@d3f86a106a0bac45b974a628896c90dbdf5c8093","number":13,"status":"completed","conclusion":"success"},{"name":"Verify archive, import off-host bundle and verify portable identity","number":14,"status":"completed","conclusion":"success"},{"name":"Read-only School diagnostic before candidate acceptance","number":15,"status":"completed","conclusion":"success"},{"name":"Download and load exact hosted-verified image","number":16,"status":"completed","conclusion":"success"},{"name":"Verify and load exact hosted-verified image","number":17,"status":"completed","conclusion":"success"},{"name":"Verify actual gateway Caddy with isolated candidate fixture","number":18,"status":"completed","conclusion":"success"},{"name":"Resolve authoritative School sync secret","number":19,"status":"completed","conclusion":"success"},{"name":"Clone preflight and guarded production cutover","number":20,"status":"completed","conclusion":"success"},{"name":"School diagnostic and real browser acceptance after cutover","number":21,"status":"completed","conclusion":"success"},{"name":"Remove only this downloaded temporary archive","number":22,"status":"completed","conclusion":"success"},{"name":"Remove temporary School SSH material","number":23,"status":"completed","conclusion":"success"},{"name":"Production summary","number":24,"status":"completed","conclusion":"success"},{"name":"Post Check out exact verified release","number":48,"status":"completed","conclusion":"success"},{"name":"Complete job","number":49,"status":"completed","conclusion":"success"}]}]},"commit":{"sha":"77f26ec9bcba7233f39d5e8cb9f59c276bc8c1ed","tree":{"sha":"ac3fcaac06acf33bf9ee32e438d0c040adb38fd7"}}}''')
SOURCE = 'a' * 40
CURRENT = 90000000001

def run(identity=CURRENT, attempt=1, status='in_progress', conclusion=None):
    value = copy.deepcopy(ACTUAL['run'])
    value.update(id=identity, path=gate.CONSUMER_PATH, name='Deploy R13', head_sha=SOURCE,
