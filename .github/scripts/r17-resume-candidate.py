...
state = checked_module('r14_candidate_state', 'r17-candidate-state.py', '5279102d0d9e32bc23ff8f4f8db98404111df3fac19be42f9e5c134027e20f29')
adoption = state.adoption
backup = adoption.r7
controller = checked_module('r14_backup_controller', 'r17-backup-controller.py', '9a44119571777a24a595f7916d921a151312518697e415385876093806e83135')
