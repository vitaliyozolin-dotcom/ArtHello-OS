...
def main():
    ...
    url = 'https://api.github.com/repos/vitaliyozolin-dotcom/ArtHello-OS/contents/docs/acceptance/2026-09-08-school-live-acceptance-r4.json?ref=codex/recovery-evidence-20260907'
