...
PINS = {
    "r17-candidate-state.py": "5279102d0d9e32bc23ff8f4f8db98404111df3fac19be42f9e5c134027e20f29",
...
def checked_state():
    ...
    module.__file__ = str(HERE / "r17-candidate-state.py")
    exec(compile(sources["r17-candidate-state.py"], module.__file__, "exec"), module.__dict__)
    return module
