...
adoption = checked_module('r14_adoption', 'r14-backup-adoption.py', '1b25bb227359f602cfe501671c99ce83a2a0a9f62f0ba6e47253425a1e6b2c3f')
...
def validate_context(context):
    ...
    if (context['previousName'] != 'arthello-direct-' + adoption.LIVE_RUN + '-1'
        ...
        raise ValueError('Previous application must be the accepted R13 runtime')
