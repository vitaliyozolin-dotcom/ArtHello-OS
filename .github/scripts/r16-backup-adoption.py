#!/usr/bin/env python3
"""Adopt the fixed R12 backup service for a release after accepted R15, preserving the fixed R13 reader as history."""
import hashlib
import argparse
import datetime
import fcntl
...
LIVE_SHA = '4a0713b4a7d87f132e49836fe0ce9ca9258bc1ec'
LIVE_TREE = 'ac0ec2a2845eee6254ba7cf8c0e0b83d0e5848de'
LIVE_IMAGE = 'sha256:0f15a32c9dff9cd7278a1449bd66f282abc514f0392edfd57262ed25ef247a6f'
LIVE_RUN = '34445017241'
LIVE_APP_ID = '3b81e98433e7d948d899fcfc1a9e94ee15faa3ef17cb1d1d4d1cb5c371ff67c7'
HISTORICAL_SHA = 'f5fa3e46e3510e6fc98ae4455f4b499c0ba30695'
HISTORICAL_TREE = '3f49b1b7c0e3ed6dfdaaafbccc071386c9b5edde'
HISTORICAL_IMAGE = 'sha256:99b77401c79bb439d3ecbc06d6895b22aae311b3264c27be7dcdf9fabb4b3554'
HISTORICAL_RUN = '34340461537'
HISTORICAL_APP_ID = '6356740984e0c7ad1ad6a30da8bd8f5c6c0b8c268d11f35d09e5984e76c2f76e'
require = r7.require
...
class Adoption:
    def __init__(self, args, docker, state, accepted, boundary):
        ...
        require(args.release_sha != ACCEPTED_SHA and args.image_id != ACCEPTED_IMAGE
                ...
                and args.tree_sha != HISTORICAL_TREE and args.run_id != HISTORICAL_RUN, 'FRESH_RELEASE_REQUIRED')
    ...
    def no_duplicates(self):
        ...
        for identity in inventory:
            ...
            if mounted & protected and identity != ACCEPTED_WORKER_ID:
                ...
                historical_app = (identity == HISTORICAL_APP_ID
                    and metadata.get('Image') == HISTORICAL_IMAGE
                    and metadata.get('Name') == '/arthello-direct-' + HISTORICAL_RUN + '-1'
                    and labels.get('arthello.release.sha') == HISTORICAL_SHA
