...
CONSUMER_PATH = '.github/workflows/deploy-arthello-recovery-r10-20260909.yml'
...
def run():
    ...
    assert release not in (INSTALL_SHA, PREVIOUS_SHA, 'dbe630145a3828643fcfb9f202b1239e8cc54826', R8_SHA, R9_SHA), 'R10 candidate identity must differ from preserved releases'
    ...
    print('ARTHELLO_D083_PRESERVED_R5_R8_R9_ABORT_REPLAY_BOUNDARY=VERIFIED')
...
def validate_history(runs, get, repository, release, current_run, current_attempt, get_logs=None):
    resume = False
    assert release != R9_SHA and current_run != R9_RUN, 'Frozen R9 cannot be rearmed as R10'
