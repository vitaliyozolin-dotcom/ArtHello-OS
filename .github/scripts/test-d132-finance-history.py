...
class D132FinanceHistoryTests(unittest.TestCase):
    ...
    def test_parent_scope_and_content_drift_fail_closed(self):
        ...
        cases = [
            ...
            (history.BASELINE, history.EXPECTED_CHANGES | {"other"}, files, pins, "CHANGE_SCOPE_DRIFT"),
            (history.BASELINE, history.EXPECTED_CHANGES, {**files, next(iter(files)): b"changed"}, pins, "CURRENT_SOURCE_DRIFT"),
        ]
