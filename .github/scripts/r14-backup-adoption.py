#!/usr/bin/env python3
"""Adopt the fixed R12 backup service for a release after accepted R13."""
import hashlib
import argparse
import datetime
import fcntl
...
LIVE_SHA = 'f5fa3e46e3510e6fc98ae4455f4b499c0ba30695'
LIVE_TREE = '3f49b1b7c0e3ed6dfdaaafbccc071386c9b5edde'
LIVE_IMAGE = 'sha256:99b77401c79bb439d3ecbc06d6895b22aae311b3264c27be7dcdf9fabb4b3554'
LIVE_RUN = '34340461537'
LIVE_APP_ID = '6356740984e0c7ad1ad6a30da8bd8f5c6c0b8c268d11f35d09e5984e76c2f76e'
require = r7.require
...
class Adoption:
    def __init__(self, args, docker, state, accepted, boundary):
        ...
        require(args.release_sha != ACCEPTED_SHA and args.image_id != ACCEPTED_IMAGE
                ...
                and args.tree_sha != LIVE_TREE and args.run_id != LIVE_RUN, 'FRESH_RELEASE_REQUIRED')
