...
adoption = checked_module('r14_adoption', 'r18-backup-adoption.py', '41748c8a62b23fd0052436dea28ce3a2af651eb5f1e6269df1272cd33e2d4b8a')
...
def validate_context(context):
    ...
    if (context['previousName'] != 'arthello-direct-' + adoption.LIVE_RUN + '-1'
        ...
        raise ValueError('Previous application must be the accepted R17 runtime')
