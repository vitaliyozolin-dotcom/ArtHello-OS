#!/usr/bin/env python3
"""Bind both frozen R10 browser phases to verified R13 durable identities."""
import hashlib
import json
import os
...
PINS = {
    "r13-candidate-state.py": "7387d5d189c8ba1c1801899756fabad3428dd8661c8d0fc6ff1fe506cfad355c",
...
def checked_state():
    ...
    module = ModuleType("r13_verified_candidate")
    module.__file__ = str(HERE / "r13-candidate-state.py")
    exec(compile(sources["r13-candidate-state.py"], module.__file__, "exec"), module.__dict__)
    return module
...
def main():
    try:
        ...
        print("ARTHELLO_R13_BROWSER_IDENTITY=BLOCKED", file=sys.stderr)
        return 1
    print("ARTHELLO_R13_BROWSER_IDENTITY=VERIFIED")
    return 0
