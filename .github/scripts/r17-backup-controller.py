...
def checked_module():
    ...
    if hashlib.sha256(source).hexdigest() != '598a596d4dc8ea01b8d09a755ed1f06c5194c64a6a6901333c86e3c296c2cab4':
...
LIVE_CONTEXT_SHA256 = 'a43ac4fa996ffcf18854afc83c3245552fe804e80abb94a25a0fa515cd2a9eef'
...
def accepted_live_predecessor(docker):
    """Prove the retained R15 app through accepted R16's exact public context."""
    root = Path.home() / '.config/arthello/release-state'
    directory = adoption.private_directory(root)
    try:
