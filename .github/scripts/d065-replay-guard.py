...
def run():
    ...
    runs = get('/actions/workflows/deploy-arthello-recovery-r3-20260908.yml/runs?event=workflow_run&head_sha=' + release + '&per_page=100')
    ...
    for previous in runs['workflow_runs']:
        ...
        assert previous['path'].split('@')[0] == '.github/workflows/deploy-arthello-recovery-r3-20260908.yml'
    ...
    print('ARTHELLO_D065_REPLAY_BOUNDARY=VERIFIED')
