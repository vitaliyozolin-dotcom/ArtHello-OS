...
resume = load('r14_resume_test', 'r14-resume-candidate.py')
state = resume.state
adoption = state.adoption
public = load('r14_public_test', 'r14-public-audit.py')
...
backup_tests = load('r14_backup_fixture', 'test-r14-backup-adoption.py')
controller_tests = load('r14_controller_fixture', 'test-r14-backup-controller.py')
