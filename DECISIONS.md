...
Импорт расписания, каникул и КТП идемпотентен и до открытия записи обязан пройти точную read-only сверку 189 строк, 4 периодов, 170 тем, 170 сессий, provenance, SQLite integrity и foreign keys. Учитель сохраняет право вручную менять фактическую тему и домашнее задание; кнопка «урок проведён» и автоматический сдвиг будущих тем не вводятся. Методист проверяет и возвращает план с комментарием, завуч утверждает календарь, расписание, назначения и активацию программы.
